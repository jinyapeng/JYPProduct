...
+(void)initialize
{
    ...
    navigation.barTintColor     = [UIColor gradientFromColor:[UIColor firstAppNavigationBarColor] toColor:[UIColor lastAppNavigationBarColor] withWidth:KWIDTH];
//    navigation.barTintColor     = [UIColor whiteColor];
