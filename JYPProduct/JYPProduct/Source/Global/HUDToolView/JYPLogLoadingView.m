...
@implementation JYPLogLoadingView
...
-(void)createUI
{
    ...
    _imageView1.backgroundColor = rgb(249, 49, 52, 1);
    ...
    _imageView2.backgroundColor = rgb(249, 49, 52, 1);
...
+(void)showInView:(UIView *)view{
    ...
    JYPLogLoadingView *loading = [[JYPLogLoadingView alloc] initWithFrame:view.bounds];
    [loading show];
...
+(void)dismissInView:(UIView *)view{
    ...
    for (JYPLogLoadingView *loading in view.subviews) {
        if ([loading isKindOfClass:[JYPLogLoadingView class]]) {
